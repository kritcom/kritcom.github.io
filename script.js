let githubUser = 'kritcom'
let repo = 'kritcom.github.io'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbzPOc2giUhvfD15RXv6WX2ZoBtBOHhcOLEAVddYvGmT1mV0XAp4c74Tuv-IsUVI9P3X/exec');
